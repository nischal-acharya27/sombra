...
import { GATE_10 } from './gate10.js';
import { GATE_11 } from './gate11.js';

export const GATES = [GATE_1, GATE_2, GATE_3, GATE_4, GATE_5, GATE_6, GATE_7, GATE_8, GATE_9, GATE_10, GATE_11];
